<x-app-layout>
  ...
  <input type="text" name="country" id="country" class="mt-2 w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
      ...
      <!-- Hotel -->
      <div>
        <label for="hotel" class="block text-lg font-medium text-gray-700">Hotel</label>
        <input type="text" name="hotel" id="hotel" class="mt-2 w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
      </div>

      <!-- Flight -->
      <div>
        <label for="flight" class="block text-lg font-medium text-gray-700">Flight</label>
        <input type="text" name="flight" id="flight" class="mt-2 w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
      </div>
