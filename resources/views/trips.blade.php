<x-app-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6 bg-gray-100">
        ...
        <div class="flex flex-col justify-between bg-gray-200 w-full h-[700px] mt-6 rounded-md shadow-md overflow-hidden shadow-4xl">
            <img src="{{ asset('storage/' . $trip->image) }}" class="w-full h-72 object-cover" alt="Trip image">
            ...
            <div class="px-4 pb-4">
                <form action="{{ route('cart.store') }}" method="POST">
                    @csrf
                    <input type="hidden" name="item_type" value="trip">
                    <input type="hidden" name="item_id" value="{{ $trip->id }}">
